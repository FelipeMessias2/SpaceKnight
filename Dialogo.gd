extends CanvasLayer
## Sistema de diálogo estilo Celeste: o jogo PAUSA, aparece uma caixa com
## retrato e o texto é digitado letra por letra.
##
## Uso:  Dialogo.falar([
##           {"quem": "kael", "texto": "Onde estou?"},
##           {"quem": "vera", "texto": "Na Estação Meridian."},
##       ])
## O sinal `terminado` é emitido quando a última fala fecha.
